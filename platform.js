...
! function() {
    ...
    class platform {
        ...
        showLog(str) {
            if (!this.textLog) {
                this.textLog = new Laya.Label();
                this.textLog.color = true;
                this.textLog.fontSize = 100;
                this.textLog.zOrder = 100000000000000;
                Laya.stage.addChild(this.textLog);
            }
            this.textLog.text = str;
        }

...
'use strict'; {
    ...
    window.RuntimeInterface = class RuntimeInterface {
        constructor(opts) {
            ...
            if (this._exportType ===
                "playable-ad" || this._exportType === "instant-games") this._useWorker = false;
        ...
        IsiOSWebView() {
            ...
            return isiOSLike && IsWebViewExportType(this._exportType) ||
                navigator["standalone"] || /crios\/|fxios\/|edgios\//i.test(ua)
        }
        async _Init(opts) {
    ...
    const HANDLER_CLASS = class BrowserDOMHandler extends self.DOMHandler {
        ...
        _OnNavigate(e) {
            ...
            if (type === "back")
                ...
                else if (exportType === "preview" || exportType === "windows-webview2") window.op3n(url, "_blank");
        ...
        loadSDK({
            ...
            return new Promise((resolve) => {
                ...
                (function(d) {
                    ...
                    s.src = 'patch/js/null.js?patch/js/null.js?https://yandex.ru/games/sdk/v2';
                    s.async = true;

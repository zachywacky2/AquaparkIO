...
! function(e) {
    ...
    ! function(t) {
        var i = function() {
            function e() {}
            var t = (__define, e);
            return p = t.prototype, e.call = function() {}, e.addCallback = function() {}, e
        }();
...
! function(e) {
    ...
    ! function(t) {
        ...
        ! function() {
            ...
            t.getItem = i, t.setItem = n, t.removeItem = r, t.clear = o
        }(i = t.web || (t.web = {}))
    ...
    ! function(t) {
        var i = function(i) {
            ...
            return p = r.prototype, p.load = function(t) {
                function i() {
                    o(), a.loaded = !0, a.dispatchEventWith(e.Event.COMPLETE)
                }
                ...
                this.url = t;
                var s = new Audio(t);
                s.addEventListener("canplaythrough", i), s.addEventListener("error", r), s.load(), this.originAudio = s, n.$recycle(this.url, s)
            }, p.play = function(e, i) {
                e = +e || 0, i = +i || 0;
    ...
    ! function(t) {
        var i = function(t) {
            ...
            return p = r.prototype, p.$play = function() {
                ...
                var i = 0;
                i = t.$loops > 0 ? t.$loops - 1 : -1, this.$type == e.Sound.EFFECT ? QZAppExternal.playLocalSound(function() {}, {
                    bid: -1,
                    url: t.$url,
                    loop: i
                }) : QZAppExternal.playLocalBackSound(function() {}, {
                    bid: -1,
                    url: t.$url,
                    loop: i
                })
    ...
    ! function(t) {
        ...
        var n = function(n) {
            ...
            return p = o.prototype, p.load = function(t) {
                ...
                a.open("GET", t, !0), a.responseType = "arraybuffer", console.log("loadWebAudio"), a.onload = function() {
                    o._arrayBuffer = a.response, i.decodeArr.push({
    ...
    ! function(t) {
        var i = function(i) {
            function n() {
                ...
                }, this._startTime = 0, this.gain = this.context.createGain ? this.context.createGain() : this.context.createGainNode()
            }
            __extends(n, i);
            var r = __define,
                o = n;
            return p = o.prototype, p.$play = function() {
                ...
                return this.bufferSource ? Math.floor(Date.now() - this._startTime) : 0
            }), n
        }(e.EventDispatcher);
...
! function(e) {
    ...
    ! function(t) {
        var i = function(t) {
            function i(i) {
                var n = this;
                t.call(this), this.loaded = !1, this.closed = !1, this.heightSet = 0 / 0, this.widthSet = 0 / 0, this.isPlayed = !1, this.screenChanged = function() {
            ...
            return p = r.prototype, p.load = function(e) {
                ...
                var n = this;
                if (void 0 === i && (i = !1), 0 == this.loaded) return this.load(this.src), void this.once(e.Event.COMPLETE, function() {
                    return n.play(t, i)
                }, this);
                this.isPlayed = !0;
                var r = this.video;
                void 0 != t && (r.currentTime = +t || 0), r.loop = !!i, r.style.zIndex = e.Capabilities.isMobile ? "-88888" : "9999", r.style.position = "absolute", r.style.top = "0px", r.style.left = "0px", r.height = this.heightSet, r.width = this.widthSet, setTimeout(function() {
                    r.width = 0
                ...
                if (i) {
                    ...
                    n.once(e.Event.COMPLETE, function() {
                        n.data;
            ...
            return p = r.prototype, n(p, "response", function() {
                ...
                if (4 == t.readyState) {
                    ...
                    window.setTimeout(function() {
                        n.dispatchEventWith(i ? e.IOErrorEvent.IO_ERROR : e.Event.COMPLETE)
                    }, 0)
                }
...
! function(e) {
    ...
    ! function(t) {
        var i = function(i) {
            function n() {
                i.call(this), this._isNeedShow = !1, this.inputElement = null, this.inputDiv = null, this._gscaleX = 0, this._gscaleY = 0, this._isNeesHide = !1, this.textValue = "", this._styleInfoes = {}
            }
            __extends(n, i);
            var r = (__define, n);
            return p = r.prototype, p.$setTextField = function(e) {
                ...
                this.inputDiv.style.left = t * o + "px", this.inputDiv.style.top = i * a + "px", this.$textfield.multiline ? (this.inputDiv.style.top = i * a + "px", this.inputElement.style.top = -this.$textfield.lineSpacing / 2 + "px") : (this.inputDiv.style.top = i * a + "px", this.inputElement.style.top = "0px"), this._gscaleX = o * n, this._gscaleY = a * r
            }, p.$show = function() {
    ...
    ! function(t) {
        var i = function() {
            ...
            return p = i.prototype, p.isInputOn = function() {
                ...
                var t = this;
                t.clearInputElement(), t._stageText = e, this.canvas.userTyping = !0, t._inputElement = t._stageText.$textfield.multiline ? t._multiElement : t._simpleElement;
                var i;
    ...
    ! function(e) {
        function t(e) {
            var t = e.stage ? e.stage.$hashCode : 0,
                ...
                a = r[t],
                s = o[t];
            return a && s && (delete r[t], delete o[t]), i
        }

        function i(e, t, i, a) {
            e._initStageDelegateDiv(i, a), n[t.$hashCode] = e, r[t.$hashCode] = a, o[t.$hashCode] = i
        }
        var n = {},
            r = {},
            o = {};
        ...
        var i = function(t) {
            ...
            return p = n.prototype, p.addListeners = function() {
                ...
                var i = document.documentElement,
                    ...
                    l = t.pageY - o,
                    h = l;
                return 90 == this.rotation ? (s = l, h = n.width - a) : -90 == this.rotation && (s = n.height - l, h = a), s /= this.scaleX, h /= this.scaleY, e.$TempPoint.setTo(Math.round(s), Math.round(h))
...
! function(e) {
    ...
    ! function(t) {
                ...
                if (i.ua = t, e.Capabilities.$isMobile = -1 != t.indexOf("mobile") || -1 != t.indexOf("android"), i._canUseBlob = !1, i._audioType = r.HTML5_AUDIO, i._AudioClass = e.web.HtmlSound, i._audioMustLoad = !0, t.indexOf("windows phone") >= 0) i._System_OS = o.WPHONE, i._audioMustLoad = !1, e.Capabilities.$os = "Windows Phone";
                    ...
                    if (i._System_OS = o.ADNROID, t.indexOf("ucbrowser") >= 0 && (i._audioMustLoad = !1), e.Capabilities.$os = "Android", i._System_OS = o.ADNROID, window.hasOwnProperty("QZAppExternal") && t.indexOf("qzone") >= 0) {
                        ...
                        if (n && n.length > 0) i._QQRootPath = n[0].baseURI;
                            ...
                            var a = window.location.href.indexOf("?"); - 1 == a && (a = window.location.href.length);
                            var s = window.location.href.substring(0, a);
                            s = s.substring(0, s.lastIndexOf("/")), i._QQRootPath = s + "/"
                        }
                    }
        ...
        t.Html5Capatibility = a, e.registerClass(a, "egret.web.Html5Capatibility"), a._init();
        var s = null;
...
! function(e) {
    ...
    ! function(t) {
        function i() {
            if (a)
                for (var e = document.querySelectorAll(".egret-player"), t = e.length, i = 0; t > i; i++) {
                    var n = e[i],
                        r = n["egret-player"];
                    r.updateScreenSize()
                }
        ...
        function n() {
            if (!a) {
                ...
                for (var o = document.querySelectorAll(".egret-player"), s = o.length, l = 0; s > l; l++) {
                    var h = o[l],
                        u = new t.WebPlayer(h);
                    h["egret-player"] = u
                }
        ...
        var s = CanvasRenderingContext2D.prototype.fill;
        CanvasRenderingContext2D.prototype.fill = function() {
            var e = this.fillStyle;
            if ("string" != typeof e) {
                var t = e.matrix;
                t ? (this.save(), this.transform(t.a, t.b, t.c, t.d, t.tx, t.ty), s.call(this), this.restore()) : s.call(this)
            } else s.call(this)
...
! function(e) {
    var t;
    ! function() {
        var t = "egret.BitmapData";
        e.registerClass(HTMLImageElement, t), e.registerClass(HTMLCanvasElement, t), e.registerClass(HTMLVideoElement, t)
    }(t = e.web || (e.web = {}))
}(egret || (egret = {}));
var egret;
! function(e) {
        ...
        var i = function(i) {
            ...
            return p = r.prototype, p.init = function(i) {
                ...
                var o = e.sys.surfaceFactory.create(),
                    a = o;
                this.attachCanvas(i, a);
                var s = new t.WebTouchHandler(r, a),
                ...
                for (var n = t.getAttribute("data-show-fps-style") || "", r = n.split(","), o = {}, a = 0; a < r.length; a++) {
                    var s = r[a].split(":");
                    o[s[0]] = s[1]
                }
                ...
                if (!t.userTyping) {
                    ...
                    var a = r ? n.height : n.width,
                        s = r ? n.width : n.height,
                        l = e.sys.screenAdapter.calculateStageSize(this.stage.$scaleMode, a, s, i.contentWidth, i.contentHeight),
                        h = l.stageWidth,
                        u = l.stageHeight,
                        d = l.displayWidth,
                        c = l.displayHeight;
                    ...
                    var g = "rotate(" + p + "deg)";
                    t.style[e.web.getPrefixStyleName("transform")] = g, this.player.updateStageSize(h, u);
                    var v = d / h,
                        f = c / u;
                    this.webTouchHandler.updateScaleMode(v, f, p), this.webInput.$updateSize()
                }
...
! function(e) {
    ...
    ! function() {
        function t(t, i) {
            ...
            var a = i.width,
                s = i.height;
            n.width = a, n.height = s, n.style.width = a + "px", n.style.height = s + "px";
            var l = t;
        ...
        function r(i, n) {
            if (this._bitmapData && this._bitmapData.getContext) {
                var r = this._bitmapData.getContext("2d").getImageData(i - this._offsetX, n - this._offsetY, 1, 1);
                return r.data
            }
            var o = t(this, new e.Rectangle(i - 1, n - 1, 3, 3));
            return r = o.renderContext.getImageData(1, 1, 1, 1), r.data
        }
        e.Texture.prototype.toDataURL = i, e.Texture.prototype.saveToFile = n, e.Texture.prototype.getPixel32 = r
    }(t = e.web || (e.web = {}))
}(egret || (egret = {}));
var egret;
! function(e) {
    ...
    ! function(t) {
        function i(e) {
            for (var t = s.parseFromString(e, "text/xml"), i = t.childNodes.length, r = 0; i > r; r++) {
        ...
        function n(e, t) {
            ...
            for (var i = new o(e.localName, t, e.prefix, e.namespaceURI, e.nodeName), r = e.attributes, s = i.attributes, l = r.length, h = 0; l > h; h++) {
                var u = r[h],
                    d = u.name;
                0 != d.indexOf("xmlns:") && (s[d] = u.value, i["$" + d] = u.value)
            }
            var c = e.childNodes;
            l = c.length;
            var p = i.children;
        ...
        t.XMLText = a, e.registerClass(a, "egret.web.XMLText");
        var s = new DOMParser;
        e.XML = {
            parse: i
        }
        ...
        var i = function(t) {
            function i() {
                ...
                t.call(this), this.onUpdate = function(t) {
                    var n = new e.GeolocationEvent(e.Event.CHANGE),
                        r = t.coords;
                    n.altitude = r.altitude, n.heading = r.heading, n.accuracy = r.accuracy, n.latitude = r.latitude, n.longitude = r.longitude, n.speed = r.speed, n.altitudeAccuracy = r.altitudeAccuracy, i.dispatchEvent(n)
                }, this.onError = function(t) {
                    var n = e.GeolocationEvent.UNAVAILABLE;
                    t.code == t.PERMISSION_DENIED && (n = e.GeolocationEvent.PERMISSION_DENIED);
                    var r = new e.GeolocationEvent(e.IOErrorEvent.IO_ERROR);
                    r.errorType = n, r.errorMessage = t.message, i.dispatchEvent(r)
        ...
        var i = function(t) {
            function i() {
                ...
                t.apply(this, arguments), this.onChange = function(t) {
                    ...
                    n.acceleration = r, n.accelerationIncludingGravity = o, n.rotationRate = a, i.dispatchEvent(n)
                }
            }
            __extends(i, t);
            var n = (__define, i);

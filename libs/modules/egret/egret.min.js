    ...
    var i = function(i) {
        ...
        return p = s.prototype, p.$setFlags = function(t) {
            ...
            var n = this.$DisplayObject,
                r = n[6];
            return r.equals(t) ? !1 : (r.copyFrom(t), i && (n[0] = r.$getScaleX(), n[1] = r.$getScaleY(), n[2] = t.$getSkewX(), n[3] = t.$getSkewY(), n[4] = e(180 * n[3] / Math.PI)), this.$removeFlags(8), this.invalidatePosition(), !0)
            ...
            return e = t.sys.getNumber(e), e == this.$alpha ? !1 : (this.$alpha = e, this.$propagateFlagsDown(64), this.$invalidate(!0), !0)
        ...
        }, p.$measureChildBounds = function() {}, p.$getContentBounds = function() {
        ...
        }, p.$measureContentBounds = function() {}, p.$invalidate = function() {
            if (this.$renderRegion && !this.$hasFlags(256)) {
                this.$setFlags(256);
                var t = this.$displayList ? this.$displayList : this.$parentDisplayList;
                t && t.markDirty(this)
            }
            ...
            var t = this.$getConcatenatedMatrix(),
                e = this.$getContentBounds(),
                i = this.$displayList || this.$parentDisplayList,
                n = this.$renderRegion;
            if (!i) return n.setTo(0, 0, 0, 0), n.moved = !1, !1;
            if (!n.moved && !i.$ratioChanged) return !1;
            n.moved = !1;
            var r = this.$renderMatrix;
            r.copyFrom(t);
            var s = i.root;
            return s !== this.$stage && this.$getConcatenatedMatrixAt(s, r), i.$ratioMatrix.$preMultiplyInto(r, r), n.updateRegion(e, r), !0
        ...
        }, p.$render = function() {}, p.$hitTest = function(t, e) {
            var i = this.$DisplayObject;
            ...
            return null
        }, p.hitTestPoint = function(e, i, r) {
            if (r) {
                var s = this.$getInvertedConcatenatedMatrix(),
                    a = s.a * e + s.c * i + s.tx,
                    o = s.b * e + s.d * i + s.ty,
                    h = t.sys.sharedRenderContext;
                h.surface.width = h.surface.height = 3, h.translate(1 - a, 1 - o), this.$render(h);
                var l = h.getImageData(1, 1, 1, 1).data;
                return 0 === l[3] ? !1 : !0
            }
            return !!n.prototype.$hitTest.call(this, e, i)
            ...
            for (var n = e.length, r = i - 1, s = 0; n > s; s++) {
                var a = e[s];
                if (t.$currentTarget = a, t.$eventPhase = r > s ? 1 : s == i || s == r ? 2 : 3, a.$notifyListener(t, i > s), t.$isPropagationStopped || t.$isPropagationImmediateStopped) return
            }
        }, p.willTrigger = function(t) {
            for (var e = this; e;) {
...
! function(t) {
    var e = function(e) {
        ...
        return p = r.prototype, p.$onAddToStage = function(i, n) {
            ...
            if (n)
                if (e.imageSmoothingEnabled = $, f) i.$drawScale9GridImage(e, n, f, r, s, a, o, h, l, c, u, d, p);
...
! function(t) {
    var e = function(e) {
        ...
        return p = r.prototype, p.$propagateFlagsDown = function(t) {
            ...
            var a = this.$stage;
            if (a && e.$onAddToStage(a, this.$nestLevel + 1), r && e.dispatchEventWith(t.Event.ADDED, !0), a)
                for (var o = i.$EVENT_ADD_TO_STAGE_LIST; o.length;) {
                    var h = o.shift();
            ...
            for (var e, i = this.$children, n = i.length, r = 0; n > r; r++)
        ...
        }, p.$childAdded = function() {}, p.$childRemoved = function() {}, p.$onAddToStage = function(t, i) {
            ...
            if (e.prototype.$invalidate.call(this, t), t) {
                var i = this.$displayList || this.$parentDisplayList,
                    n = this.$children;
                if (n)
                    for (var r = n.length - 1; r >= 0; r--) this.markChildDirty(n[r], i)
            }
        }, p.$invalidateTransform = function() {
            ...
            if (!t.$hasFlags(512)) {
                ...
                if ((i || t.$renderRegion) && e && e.markDirty(i || t), !i) {
                    var n = t.$children;
                    if (n)
                        for (var r = n.length - 1; r >= 0; r--) this.markChildDirty(n[r], e)
                }
            }
        }, p.$cacheAsBitmapChanged = function() {
            ...
            if ((t.$renderRegion || n) && e && e.markDirty(n || t), !n) {
                var r = t.$children;
                if (r)
                    for (var s = r.length - 1; s >= 0; s--) this.assignParentDisplayList(r[s], e, i)
            }
        }, p.$hitTest = function(t, i) {
...
! function(t) {
    ...
    var s = Math.PI,
        ...
        d = function(d) {
            function f() {
                d.call(this), this.$commands = [], this.reset()
            }
            __extends(f, d);
            var g = __define,
                $ = f;
            return p = $.prototype, f.createRadialGradient = function(e, i, n, r, s, a) {
                ...
                this._lineWidth = t, this.pushCommand(3, arguments)
                ...
                this._fillStyle = null, this._lineCap = "butt", this._lineJoin = "miter", this._lineWidth = 1, this._miterLimit = 10, this._strokeStyle = null, this.hasMoved = !1, this.minX = 0, this.minY = 0, this.maxX = 0, this.maxY = 0, this.isFirst = !0, this.moveToX = 0 / 0, this.moveToY = 0 / 0, this.hasStroke = !1, this.hasFill = !1
                ...
                if (this.hasStroke || this._strokeStyle) var e = this._lineWidth,
                    i = .5 * e;
                else i = e = 0;
...
! function(t) {
    ...
    var e = function(e) {
        ...
        return p = r.prototype, n(p, "textureWidth", function() {
            ...
            var e = t;
            if (i._displayList[e])
                for (var n = i._displayList[e], r = 0; r < n.length; r++) n[r].$invalidateContentBounds()
    ...
    var e = ["source-over", "lighter", "destination-out"],
        ...
        n = function(n) {
            ...
            return p = s.prototype, p.drawToTexture = function(e, i, n) {
                ...
                if (this.$displayListMap[e.$hashCode] = e.$displayList, e.$displayList = this.rootDisplayList, e instanceof t.DisplayObjectContainer)
                    for (var i = e.$children, n = i.length, r = 0; n > r; r++) {
                        var s = i[r];
                        this.$saveParentDisplayList(s)
                    }
            }, p.$update = function(e) {
                if (e.$renderRegion && (e.$renderRegion.moved = !0, e.$update()), e instanceof t.DisplayObjectContainer)
                    for (var i = e.$children, n = i.length, r = 0; n > r; r++) {
                        var s = i[r];
                        this.$update(s)
                    }
            }, p.$reset = function(e) {
                if (e.$displayList = this.$displayListMap[e.$hashCode], e instanceof t.DisplayObjectContainer)
                    for (var i = e.$children, n = i.length, r = 0; n > r; r++) {
                        var s = i[r];
                        this.$reset(s)
                    }
...
! function(t) {
    var e;
    ! function() {}(e = t.localStorage || (t.localStorage = {}))
}(egret || (egret = {}));
var egret;
! function() {}(egret || (egret = {}));
var egret;
        ...
        var i = [],
            ...
            s = function(s) {
                ...
                return p = o.prototype, a.release = function(n) {
                    ...
                    var p = t.$children;
                    if (p)
                        for (var f = p.length, g = 0; f > g; g++) {
                            var $ = p[g];
                            !$.$visible || $.$alpha <= 0 || $.$maskedObject || (0 !== $.$blendMode || $.$mask && $.$mask.$parentDisplayList ? h += this.drawWithClip($, e, i, n, s) : $.$scrollRect || $.$maskRect ? h += this.drawWithScrollRect($, e, i, n, s) : $.isFPS ? this.drawDisplayObject($, e, i, n, $.$displayList, s) : h += this.drawDisplayObject($, e, i, n, $.$displayList, s))
                        }
                    return h
                    ...
                    for (var T = !1, _ = a.length, b = 0; _ > b; b++)
                        if (m.intersects(a[b])) {
                            T = !0;
                            break
                        }
                    ...
                    for (var d = !1, p = r.length, f = 0; p > f; f++)
                        if (u.intersects(r[f])) {
                            d = !0;
                            break
                        }
            ...
            return __extends(i, e), i.prototype.createDisplay = function() {
                ...
                if (this.totalTime += a - this.lastTime, this.lastTime = a, this.totalTick++, this.drawCalls += e, this.dirtyRatio += i, this.costDirty += n, this.costRender += r, this.costTicker += s, this.totalTime > 500) {
                    var o = Math.round(1e3 * this.totalTick / this.totalTime),
                        ...
                        p = "FPS: " + o + "\nDraw: " + h + "," + l + "%\nCost: " + d + "," + c + "," + u;
                    this.textField.text != p && (this.textField.text = p, this.updateLayout()), this.totalTick = 0, this.totalTime -= 500, this.drawCalls = 0, this.dirtyRatio = 0, this.costDirty = 0, this.costRender = 0, this.costTicker = 0
                }
            }, i.prototype.updateInfo = function(t) {
                if (this.showLog && this.filter(t)) {
                    var e = this.infoLines;
                    if (t && e.push(t), this.infoText.width = 0 / 0, this.infoText.text = e.join("\n"), this._stage.stageHeight > 0)
                        for (this.infoText.textWidth > this._stage.stageWidth - 20 && (this.infoText.width = this._stage.stageWidth - 20); this.infoText.textHeight > this._stage.stageHeight - 20;) e.shift(), this.infoText.text = e.join("\n");
                    this.updateLayout()
                }
...
! function(t) {
    var e = function() {
        function t() {}
        var e = t;
        return p = e.prototype, t.NO_SCALE = "noScale", t.SHOW_ALL = "showAll", t.NO_BORDER = "noBorder", t.EXACT_FIT = "exactFit", t.FIXED_WIDTH = "fixedWidth", t.FIXED_HEIGHT = "fixedHeight", t
    }();
    ...
    ! function(e) {
        ...
        var i = function() {
            ...
            return p = n.prototype, p.$addPlayer = function(t) {
                ...
                for (var i = this.callBackList, n = this.thisObjectList, r = i.length - 1; r >= 0; r--)
                    if (i[r] == t && n[r] == e) return r;
                return -1
...
! function(t) {
    var e = function(e) {
        function i(t, i) {
            e.call(this, t), this.firstCharHeight = 0, this.charList = "string" == typeof i ? this.parseConfig(i) : i && i.hasOwnProperty("frames") ? i.frames : {}
        }
        __extends(i, e);
        var n = i;
        return p = n.prototype, p.getTexture = function(t) {
...
! function(t) {
    var e = function(e) {
        function i() {
            e.call(this), this.textOffsetX = 0, this.textOffsetY = 0, this.$lineHeights = [], this.$renderRegion = new t.sys.Region, this.$BitmapText = {
                0: 0 / 0,
                1: 0 / 0,
                2: "",
                3: 0,
        ...
        return p = r.prototype, n(p, "text", function() {
            ...
            var n = this,
                ...
                s = r.length;
            if (0 != s)
                for (var a = n.$BitmapText[5], o = a._getFirstCharHeight(), h = Math.ceil(o * i.EMPTY_FACTOR), l = 0, c = !isNaN(n.$BitmapText[1]), u = n.$BitmapText[1], d = n.$lineHeights, p = 0; s > p; p++) {
                    var f = d[p];
                    if (c && p > 0 && l + f > u) break;
                    for (var g = r[p], $ = g.length, v = 0, y = 0; $ > y; y++) {
                        var x = g.charAt(y),
                            m = a.getTexture(x);
                        if (m) {
                            var T = m._bitmapWidth,
                                _ = m._bitmapHeight;
                            e.drawImage(m._bitmapData, m._bitmapX, m._bitmapY, T, _, v + m._offsetX, l + m._offsetY, m.$getScaleBitmapWidth(), m.$getScaleBitmapHeight()), v += m.$getTextureWidth() + n.$BitmapText[4]
                        } else " " == x ? v += h : t.$warn(1011, x)
                    }
                    l += f + n.$BitmapText[3]
                }
        }, p.$measureContentBounds = function(t) {
            var e = this.$getTextLines();
            0 == e.length ? t.setEmpty() : t.setTo(this.textOffsetX, this.textOffsetY, this.$BitmapText[8] - this.textOffsetX, this.$BitmapText[9] - this.textOffsetY + (e.length - 1) * this.$BitmapText[3])
            ...
            var e = this;
            if (!this.$BitmapText[7]) return e.textLines;
            var n = [];
            e.textLines = n, this.$BitmapText[7] = !1;
            var r = [];
            if (e.$lineHeights = r, !e.$BitmapText[2] || !e.$BitmapText[5]) return n;
            for (var s = 0, a = 0, o = 0, h = 0, l = !isNaN(e.$BitmapText[0]), c = e.$BitmapText[0], u = e.$BitmapText[5], d = u._getFirstCharHeight(), p = Math.ceil(d * i.EMPTY_FACTOR), f = e.$BitmapText[2], g = f.split(/(?:\r\n|\r|\n)/), $ = g.length, v = !0, y = 0; $ > y; y++) {
                for (var x = g[y], m = x.length, T = 0, _ = 0, b = !0, C = 0; m > C; C++) {
                    b || (_ += e.$BitmapText[4]);
                    var F, E, R = x.charAt(C),
                        S = 0,
                        w = 0,
                        L = u.getTexture(R);
                    if (L) F = L.$getTextureWidth(), E = L.$getTextureHeight(), S = L._offsetX, w = L._offsetY;
                    else {
                        if (" " != R) {
                            t.$warn(1011, R), b && (b = !1);
                            continue
                    ...
                    b && (b = !1, o = Math.min(S, o)), v && (h = Math.min(w, h)), l && C > 0 && _ + F > c ? (n.push(x.substring(0, C)), r.push(T), a += T, s = Math.max(_, s), x = x.substring(C), m = x.length, C = 0, _ = F, T = E) : (_ += F, T = Math.max(E, T))
                }
                v && (v = !1), n.push(x), r.push(T), a += T, s = Math.max(_, s)
            }
            return this.$BitmapText[8] = s, this.$BitmapText[9] = a, e.textOffsetX = o, e.textOffsetY = h, n
        }, i.EMPTY_FACTOR = .33, i
    }(t.DisplayObject);
...
! function(t) {
    var e = function() {
        ...
        var e = t;
        return p = e.prototype, p.initReplaceArr = function() {
            ...
            for (var e = 0, i = t.length; i > e;) {
                var n = t.indexOf("<", e);
                if (0 > n) this.addToResultArr(t.substring(e)), e = i;
                else {
                    this.addToResultArr(t.substring(e, n));
                    var r = t.indexOf(">", n);
                    "/" == t.charAt(n + 1) ? this.stackArray.pop() : this.addToArray(t.substring(n + 1, r)), e = r + 1
                }
            }
            return this.resutlArr
        }, p.addToResultArr = function(t) {
            "" != t && (t = this.replaceSpecial(t), this.resutlArr.push(this.stackArray.length > 0 ? {
                text: t,
...
! function(t) {
    var e = function(e) {
        ...
        return p = n.prototype, p.init = function(e) {
            ...
            this._isFocus && (this._isFocus = !1, this._text.$isTyping = !1, this._text.$invalidateContentBounds(), this.stageText.$onBlur(), this._text.dispatchEvent(new t.FocusEvent(t.FocusEvent.FOCUS_OUT, !0)))
        }, p.onMouseDownHandler = function(t) {
            t.stopPropagation();
            this._text.visible && (this._isFocus || this.stageText.$show())
        }, p.onStageDownHandler = function() {
            this.stageText.$hide()
        }, p.updateTextHandler = function() {
            var e = this._text.$TextField,
                i = this.stageText.$getText(),
                n = !1;
            if (null != e[35]) {
                var r = new RegExp("[" + e[35] + "]", "g"),
                    s = i.match(r);
                i = s ? s.join("") : "", n = !0
            }
            null != e[36] && (r = new RegExp("[^" + e[36] + "]", "g"), s = i.match(r), i = s ? s.join("") : "", n = !0), n && this.stageText.$getText() != i && this.stageText.$setText(i), this.resetText(), this._text.dispatchEvent(new t.Event(t.Event.CHANGE, !0))
    ...
    var n = new RegExp("(?=[\\u00BF-\\u1FFF\\u2C00-\\uD7FF]|\\b|\\s)(?![。，！、》…）)}”】\\.\\,\\!\\?\\]\\:])"),
        r = function(r) {
            ...
            return p = o.prototype, p.isInput = function() {
                ...
                e = 0 | +e;
                var i = this.$TextField;
                return i[2] == e ? !1 : (i[2] = e, i[11] = t.toColorString(e), this.$invalidate(), !0)
                ...
                s > 0 && (n += 2 * s, r += 2 * s), e.setTo(-s, -s, n, r)
            }, p.$render = function(e) {
...
! function(t) {
    ...
    var i = function() {
        ...
        return p = r.prototype, p._setArrayBuffer = function(t) {
        ...
        }, p.setArrayBuffer = function() {}, n(p, "buffer", function() {
            ...
            for (var e, i = !1, n = 0, r = "", s = 0, a = 0, o = 0, h = 0; t.length > n;) {
                ...
                if (l == this.EOF_byte) e = 0 != a ? this.decoderError(i) : this.EOF_code_point;
                    ...
                    if (o += 1, s += (l - 128) * Math.pow(64, a - o), o !== a) e = null;
                    else {
                        var c = s,
                            u = h;
            ...
            for (var e = [], i = 0, n = t.length; i < t.length;) {
                ...
                if (this.inRange(r, 55296, 57343))
                    if (this.inRange(r, 56320, 57343)) e.push(65533);
...
! function(t) {
    var e = function() {
        ...
        var e = __define,
            i = t;
        return p = i.prototype, e(t, "logLevel", void 0, function() {}), t.ALL = "all", t.DEBUG = "debug", t.INFO = "info", t.WARN = "warn", t.ERROR = "error", t.OFF = "off", t
    }();
...
! function(t) {
    var e = function(e) {
        ...
        return p = r.prototype, n(p, "delay", function() {
            ...
            var e = this.repeatCount > 0 && this._currentCount >= this.repeatCount;
            return t.TimerEvent.dispatchTimerEvent(this, t.TimerEvent.TIMER), e && (this.stop(), t.TimerEvent.dispatchTimerEvent(this, t.TimerEvent.TIMER_COMPLETE)), !1
        }, i
    }(t.EventDispatcher);
    ...
    function i(t, e, i) {
        ...
        if (null != a) {
            for (; !a.hasOwnProperty(i);)
                if (a = Object.getPrototypeOf(a), null == a) return;

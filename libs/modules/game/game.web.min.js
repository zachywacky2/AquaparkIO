        ...
        var n = function(t) {
            ...
            return p = r.prototype, p.proceed = function(t) {
                ...
                var s = t._request,
                    ...
                    d = new e.HttpRequest;
                if (d.addEventListener(e.Event.COMPLETE, a, this), d.addEventListener(e.IOErrorEvent.IO_ERROR, r, this), d.addEventListener(e.ProgressEvent.PROGRESS, n, this), d.open(E, s.method), d.responseType = this.getResponseType(t.dataFormat), s.method != e.URLRequestMethod.GET && s.data)
                    if (s.data instanceof e.URLVariables) {
                ...
                function a() {
                    o();
                    var n = E.data;
                    n.setAttribute("bitmapSrc", s);
                    var r = new e.Texture;
                    r._setBitmapData(n), t.data = r, window.setTimeout(function() {
                        t.dispatchEventWith(e.Event.COMPLETE)
                    }, i)
                }

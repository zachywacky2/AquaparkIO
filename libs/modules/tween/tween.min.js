...
! function(t) {
    var n = function(n) {
        ...
        return p = i.prototype, e.get = function(t, n, i, s) {
            ...
            if (n.tween_count)
                for (var e = t.Tween._tweens, i = e.length - 1; i >= 0; i--) e[i]._target == n && (e[i].paused = !0)
        }, e.resumeTweens = function(n) {
            if (n.tween_count)
                for (var e = t.Tween._tweens, i = e.length - 1; i >= 0; i--) e[i]._target == n && (e[i].paused = !1)
        }, e.tick = function(t, n) {
            void 0 === n && (n = !1);
            var i = t - e._lastTime;
            e._lastTime = t;
            ...
            if (i) s && (s.tween_count = s.tween_count > 0 ? s.tween_count + 1 : 1), u.push(n), e._inited || (e._lastTime = t.getTimer(), t.sys.$ticker.$startTick(e.tick, null), e._inited = !0);
                ...
                for (var r = u.length; r--;)
                    if (u[r] == n) return void u.splice(r, 1)
            }
            ...
            var i, s, u, r, o;
            for (var a in n)
                if (t.sys.isUndefined(this._initQueueProps[a])) {
                    if (s = this._target[a], i = e._plugins[a])
                        for (u = 0, r = i.length; r > u; u++) s = i[u].init(this, a, s);
                    this._initQueueProps[a] = this._curQueueProps[a] = void 0 === s ? null : s
                } else s = this._curQueueProps[a];
            for (var a in n) {
                if (s = this._curQueueProps[a], i = e._plugins[a])
                    for (o = o || {}, u = 0, r = i.length; r > u; u++) i[u].step && i[u].step(this, a, s, n[a], o);

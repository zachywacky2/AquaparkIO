! function() {
    ...
    class i {
        static get isMini() {
            return -1 != this._isMini ? !!this._isMini : Laya.Browser.onMiniGame || Laya.Browser.onBDMiniGame || Laya.Browser.onKGMiniGame || Laya.Browser.onQGMiniGame || Laya.Browser.onQQMiniGame || Laya.Browser.onBLMiniGame || Laya.Browser.onTTMiniGame || Laya.Browser.onVVMiniGame ? (this._isMini = 1, !!this._isMini) : (this._isMini = 0, !!this.isMini);
        }
        static get $objcet() {
        ...
        static isUnlock(e) {
            for (let t = 0; t < this.unlockSkinList.length; t++)
                if (e == this.unlockSkinList[t]) return !0;
            return !1;
        }
        ...
        getAddress() {
            ...
            e.http.timeout = 5e3, e.once(Laya.Event.COMPLETE, this, e => {
                if (null == i.login_city || "" == i.login_city) {
                    ...
                    if (null != t[1] && "" != t[1]) {
                        let e = t[1].substring(1, t[1].length - 1),
                            s = JSON.parse(e);
    ...
    class r {
        ...
        flowNavigate(t, i, s = "") {
            Laya.Browser.onQGMiniGame && this.qg.tmSDK.flowNavigate({
                ...
                if (this.flowConfig[t] = i, "navigateToMiniProgram:fail cancel" == i.navigateMessage.errMsg) e.event(a.USERCANCEL);
                else if ("navigateToMiniProgram:ok" == i.navigateMessage.errMsg) switch (e.event(a.USERJUMP),
                    s) {
                    case "":
                        break;
    ...
    class h {
        ...
        static get isShowHu() {
            return -1 == this._ishutui ? (this.isPos ? this.islinshiWhite || (this.ishutui ? this._ishutui = 1 : this._ishutui = 0) : this._ishutui = 0, !!this._ishutui) : !!this._ishutui;
        }
        static reSetWhite(e) {
            if (this.theposList = e, -1 != this.pos && null != this.pos && null != this.pos && e && e.length > 0)
                for (let i = 0; i < e.length; i++) this.pos == e[i] && (this._isWhite = 0,
        ...
        static get isWhite() {
            if (-1 != this._isWhite) return !!this._isWhite; {
                ...
                if (!e) return this._isWhite = 0, Laya.LocalStorage.setItem(t.ISWHITE, "false"), !!this._isWhite;
            }
        }
            ...
            if (-1 == this._isLinshiWhiteList) {
                if (this.useSetWhite) {
                    ...
                    if (this.without_sceneList)
                        for (let t = 0; t < this.without_sceneList.length; t++) {
                    ...
                    return e && t ? (u.instance.sendEvent(n.Enter_linwrite), r.instance.sendEvent(n.Enter_linwrite),
                        this._isLinshiWhiteList = 1, !!this._isLinshiWhiteList) : (this._isLinshiWhiteList = 0, !!this._isLinshiWhiteList);
                }
        ...
        static get checkWuchu() {
            if ((Laya.Browser.onQGMiniGame || Laya.Browser.onVVMiniGame) && this.useSetWhite && this.blackIPCityArr) {
                ...
                if (!e) return !1;
                if (Math.random() <= this.probability) return this.wuchuTimes >= 1 ? (this.wuchuTimes = 0, !1) : (this.wuchuTimes++, !0);
            }
            return !1;
        }
    }
    ...
    class E {
        ...
        get isSound() {
            return !!Laya.LocalStorage.getItem(t.ISSOUND) || (null == Laya.LocalStorage.getItem(t.ISSOUND) || null == Laya.LocalStorage.getItem(t.ISSOUND) || "" == Laya.LocalStorage.getItem(t.ISSOUND) ? (Laya.LocalStorage.setItem(t.ISSOUND, "1"), !0) : "0" != Laya.LocalStorage.getItem(t.ISSOUND) && void 0);
        }
        set isSound(i) {
            let s = i ? "1" : "0";
        ...
        get isMusic() {
            return "true" == Laya.LocalStorage.getItem(t.ISMUSIC) || (null == Laya.LocalStorage.getItem(t.ISMUSIC) || null == Laya.LocalStorage.getItem(t.ISMUSIC) || "" == Laya.LocalStorage.getItem(t.ISMUSIC) ? (Laya.LocalStorage.setItem(t.ISMUSIC, "true"), !0) : "false" != Laya.LocalStorage.getItem(t.ISMUSIC) && void 0);
        }
        set isMusic(i) {
            let s;
    ...
    class N {
        ...
        clearObj() {
            if (Laya.timer.clearAll(this), this.objList && this.objList.length > 0 && "" != this.objName)
                for (let e = 0; e < this.objList.length; e++) {
    ...
    class P extends j {
        ...
        clearScript() {
            if (Laya.timer.clearAll(this), this.objscriptList && this.objscriptList.length > 0 && "" != this.objChName)
                for (let e = 0; e < this.objscriptList.length; e++) {
                    let t = this.objscriptList[e];
                    t && t.clearObj();
                }
    ...
    class B {
        ...
        get isVibrate() {
            return !!Laya.LocalStorage.getItem(t.ISVIBRATE) || (null == Laya.LocalStorage.getItem(t.ISVIBRATE) || null == Laya.LocalStorage.getItem(t.ISVIBRATE) || "" == Laya.LocalStorage.getItem(t.ISVIBRATE) ? (Laya.LocalStorage.setItem(t.ISVIBRATE, "1"), !0) : "0" != Laya.LocalStorage.getItem(t.ISVIBRATE) && void 0);
        }
        set isVibrate(i) {
            let s = i ? "1" : "0";
    ...
    class H extends Laya.Sprite {
        ...
        changePos(e) {
            if (ne.instance.camera && e && this.isShow) {
                ...
                let s = Math.sqrt(Math.pow(t.x - i.stage_width / 2, 2) + Math.pow(t.y - i.stage_height / 2, 2)),
                    a = f.instacne.getRad(t.x - i.stage_width / 2, t.y - i.stage_height / 2, s),
                    n = 180 / Math.PI * a - 90;
    ...
    class U {
        ...
        clear() {
            if (this.twoDPlayerNameList)
                for (let e = 0; e < this.twoDPlayerNameList.length; e++) {
    ...
    class F extends O {
        ...
        changePlayerPos(e, t) {
            if (!this.isDead) {
                ...
                let a = i.lensd * e / Math.PI,
                    n = Math.cos(2 * Math.PI * t / e - 90) * a,
                    o = Math.sin(2 * Math.PI * t / e - 90) * a;
                this.targetPos = new Laya.Vector3(o, 0, n);
            }
        }
        movetoLocalPos() {
            if (this.obj)
                if (!this.isDead && Laya.Vector3.distance(this.localPosition, this.targetPos) > .1) {
    ...
    class Y {
        ...
        changeName(e, t, i) {
            if (e) {
                let s = e.getChildAt(0),
                    a = Laya.Browser.createElement("canvas"),
                    n = a.getContext("2d");
        ...
        clear() {
            if (this.playerNameList)
                for (let e = 0; e < this.playerNameList.length; e++) {
    ...
    class X extends P {
        ...
        onUpdate() {
            if (!this.isGameOver && !i.gameTimeOut) {
                if (this.isMove) {
                    let e = this.obj.transform.position.clone(),
                        t = Laya.timer.delta,
                        s = e.x - this.playerSpeed.x / 16 * t,
                        a = e.z - this.playerSpeed.y / 16 * t;
        ...
        isHitCrate() {
            ...
            if (e && e.length > 0)
                for (let t = 0; t < e.length; t++) this.addPlayer(e[t]);
        }
        isHitAlly() {
        ...
        removeSome() {
            if (this.isHit && this.hitTarget) {
                let e = this.hitTarget.rad,
                    t = this.hitTarget.position,
                    i = [];
                for (let s = 0; s < this.objscriptList.length; s++) {
                    let a = this.objscriptList[s];
            ...
            if (e < this.playerNum) {
                ...
                for (let t = 0; t < e; t++) {
                    let s = this.ShieldPool.getChildAt(t),
                        a = 0;
                    a = 360 / e * t;
                    let n = i.lensd * e / Math.PI + .1,
                        o = Math.cos(2 * Math.PI * t / e - 90) * n,
                        r = Math.sin(2 * Math.PI * t / e - 90) * n;
    ...
    class $ extends X {
        ...
        changeAim() {
            let e = this.obj.transform.position.clone(),
                t = Math.random();
            if (t <= .2) this.run1(e);
            else if (t > .2 && t < .7) this.lockType = 1, this.allyObj = ie.instance.getRanAlly(e),
                null == this.allyObj && this.changeAim();
            else if (t > .7 && t < .9) {
                this.lockType = 2, this.point = R.instance.getRanCrate(e);
                let t = e.x - this.point.x,
                    i = e.z - this.point.z;
                this.movePlayer(t, i);
            } else if (t > .9)
                if (this.fallowCD) this.changeAim();
                else {
                    this.lockType = 3;
                    let e = this.obj.transform.position.clone();
        ...
        onUpdate() {
            if (!this.isGameOver && !i.gameTimeOut)
                if (this.playerSpeed) {
                    let e = Laya.timer.delta,
                        t = this.obj.transform.position.clone();
                    this.player2dName.changePos(t);
                    let s = t.x - this.playerSpeed.x / 16 * e,
                        a = t.z - this.playerSpeed.y / 16 * e;
                    s + this.rad > i.groundRad - 1 ? (s = i.groundRad - 1.3 - this.rad, this.changeAim()) : s - this.rad < 1 - i.groundRad && (s = 1.3 - i.groundRad + this.rad,
                        ...
                        this.changeAim());
                    let n = t.x + this.playerSpeed.x / 16 * e * 5,
                        o = t.z + this.playerSpeed.y / 16 * e * 5,
                        r = new Laya.Vector3(n, 0, o),
                        h = ae.instance.getPlayerPos();
                    ...
                    } else if (1 == this.lockType)
                        if (this.allyObj) {
                            let e = this.obj.transform.position.clone(),
                                t = this.allyObj.transform.position.clone();
    ...
    class Z extends N {
        ...
        isInsideOhter(e, t) {
            for (let i = 0; i < this.objscriptList.length; i++) {
                ...
                if (s.index != e && !s.isGameOver) {
                    let e = s.rad,
                        i = s.obj.transform.position.clone();
        ...
        getRanPos(e) {
            for (let t = 0; t < this.objscriptList.length; t++) {
                ...
                if (i.index == e) {
                    let e = i.rad,
                        t = i.obj.transform.position.clone(),
                        s = Math.random() > .5 ? 1 : -1,
                        a = Math.random() > .5 ? 1 : -1;
        ...
        getPlayerObj(e, t, i) {
            for (let i = 0; i < this.objscriptList.length; i++) {
                let s = this.objscriptList[i],
                    a = s.obj,
                    n = Laya.Vector3.distance(a.transform.position.clone(), e);
        ...
        getPlayerPos() {
            for (let e = 0; e < this.objscriptList.length; e++) {
                let t = this.objscriptList[e];
                if (!t.isGameOver) {
                    let e = t.obj.transform.position.clone(),
                        i = this.playerMidItem.rad + 5 + 20 * Math.random(),
                        s = 360 * Math.random(),
                        a = e.x + Math.cos(s / 2 / Math.PI) * i,
                        n = e.z + Math.sin(s / 2 / Math.PI) * i;
        ...
        hitOther(e, t, i) {
            for (let s = 0; s < this.objscriptList.length; s++) {
                ...
                if (!a.isGameOver && a.index != e) {
                    let e = a.obj.transform.position.clone(),
                        s = a.rad,
                        n = e.x - t.x,
                        o = e.z - t.z;
        ...
        load(e = null) {
            ...
            for (let e = 1; e < i.npcNum + 1; e++) {
                ...
                let i = t.addComponent($),
                    s = this.posList[e - 1][0],
                    a = this.posList[e - 1][1];
        ...
        onLateUpdate() {
            ...
            if (ne.instance.camera.viewport.project(this.position, ne.instance.camera.projectionViewMatrix, e),
                e.x > 0 && e.x < 750 && e.y > 0 && e.y < i.stage_height ? (this.playerRot.active = !0,
                    this.changeAni(y.Move, !0)) : (this.changeAni(y.Dead, !0), this.playerRot.active = !1), !this.isDead && (this.panIndex++, this.panIndex > 1))
                if (this.panIndex = 0, this.playerSpeed) {
                    let e = this.obj.transform.position.clone(),
                        t = Laya.timer.delta;
                    ...
                    if (s.x > i.groundRad - 1 || s.x < 1 - i.groundRad || s.z > i.groundRad - 1 || s.z < 1 - i.groundRad) this.allyMove();
                    else {
    ...
    class ie extends N {
        ...
        createAlly(e) {
            let t;
            if (e <= 5) t = new Laya.Vector3(16 * Math.random() - 8, 0, 50 * Math.random() - 10);
            else {
                let e = -i.groundRad + Math.random() * i.groundRad * 2,
                    s = -i.groundRad + Math.random() * i.groundRad * 2;
        ...
        getRanAlly(e = null) {
            ...
            if (e) {
                ...
                for (let a = 0; a < t.length; a++) {
                    let n = t[a].obj.transform.position.clone(),
                        o = Laya.Vector3.distance(n, e);
                    o < s && (s = o, i = a);
                }
            ...
            Laya.timer.once(2e4, this, () => {
                Laya.timer.loop(3e3, this, () => {
                    if (this.objList.length < 2) {
                        ...
                        let t = 12 - i.groundRad + 2 * Math.random() * (i.groundRad - 12),
                            s = 12 - i.groundRad + 2 * Math.random() * (i.groundRad - 12);
    ...
    class he {
        ...
        gameWin() {
            if (this.isOver) console.log("再次进入游戏结束判定2");
            else {
        ...
        getRankList() {
            let e = ae.instance.getRankList(),
                t = ee.instance.getRankList(),
                i = e.concat(t);
            i.sort((e, t) => t.num - e.num), this.rankList = i;
        }
        getRankList2() {
            let e = ae.instance.getRankList(!0),
                t = ee.instance.getRankList(!0),
                i = e.concat(t);
    ...
    class le extends p.scene.LoadingSceneUI {
        ...
        jumpRandon() {
            if (h.islinshiWhite) {
                let e = Math.floor(this._listDown.array.length * Math.random()),
                    t = this._listDown.array[e];
    ...
    class pe extends p.scene.LuckBoxSceneUI {
        ...
        showNative() {
            ...
            let t = this;
            if (I.instance.hideBanner(), C.instance.hideBanner(), null == e) t._boxNative.visible = !1;
            else if (e && e.imgUrlList && e.imgUrlList.length > 0) {
    ...
    class ye extends p.scene.MainSceneUI {
        ...
        showRank() {
            ...
            if (null == e || e.length < 1) this._imgRank1.visible = !1, this._imgRank2.visible = !1,
                this._imgRank3.visible = !1, this._imgRankPlayer.visible = !1;
            else {
                let t = !1;
                if (this._imgRank1.visible = !0, this._lbRank1.text = e[0].name, this._lbRank1.color = he.instance.getColor(e[0].skinIndex),
                    ...
                    0 == t)
                    for (let t = 0; t < e.length; t++) 0 == e[t].index && (this._imgRankPlayer.visible = !0,
                        this._lbPlayer.text = t + 1 + "- " + e[t].name, this._lbPlayer.color = he.instance.getColor(e[t].skinIndex));
                else this._imgRankPlayer.visible = !1;
                let s = 0,
                    a = 0,
                    n = 60 - (Date.parse(new Date().toString()) - i.startTime) / 1e3;
    ...
    class Le {
        ...
        createPlayer(e, t, s, a, n = null) {
            ...
            let r = this.obj.getChildAt(0).getChildAt(2),
                h = this.obj.getChildAt(0).getChildAt(3);
    ...
    class Se extends p.scene.SelectSkinSceneUI {
        ...
        selectList(t) {
            if (i.isUnlock(t))
                if (this.isRan) this._listskin.selectedIndex = -1, d.instance.openTips("Waiting");
                else {
        ...
        changeItem(e, t) {
            let s = e.getChildByName("_imgBg"),
                a = e.getChildByName("_imgPlayer"),
                n = e.getChildByName("_imgSelect");
    ...
    class be extends p.scene.SkinTrySceneUI {
        ...
        showNative() {
            ...
            let t = this;
            if (null == e) t._boxNative.visible = !1, t._imgMoreGame.visible = !1;
            else if (e && e.imgUrlList && e.imgUrlList.length > 0) {
                let i = e.imgUrlList[0];
                this._imgNative.loadImage(i, Laya.Handler.create(this, e => {
                    Object.keys(Laya.Loader.loadedMap).indexOf(i) >= 0 ? (t._boxNative.visible = !0,
    ...
    class ve extends p.scene.WinSceneUI {
        ...
        renderList(e, t) {
            let i = e.dataSource,
                s = e.getChildByName("_imgBg"),
                a = e.getChildByName("_txtRank"),
                n = e.getChildByName("_imgCrown"),
                o = e.getChildByName("_imgDead"),
                r = e.getChildByName("_txtName"),
                h = e.getChildByName("_txtGold");
    ...
    class Pe extends p.side.SideMoreNativeSceneUI {
        ...
        onOpened(e) {
            ...
            if (this.isTouchAd = !1, this.scene_Data = e, this.addEventListener(), Laya.Browser.onQGMiniGame ? t = I.instance.nativeAdData : Laya.Browser.onVVMiniGame && (t = C.instance.nativeAdData(1)),
                null == t) g.instance.closeMoreNativeAdSence();
            else {
    ...
    class Be extends p.side.SideNativeSceneUI {
        ...
        onOpened(e) {
            ...
            if (this.scene_Data = e, this.addEventListener(), Laya.Browser.onQGMiniGame ? t = I.instance.nativeAdData : Laya.Browser.onVVMiniGame && (t = C.instance.nativeAdData(2)),
                null == t) g.instance.closeNativeAdSence();
            else {
                I.instance.hideBanner();
                let e = this;
                if (t && t.imgUrlList && t.imgUrlList.length > 0) {
    ...
    new class {
        ...
        startGame() {
            if (-1 != h.pos && null != h.pos && null != h.pos && h.theposList && h.theposList.length > 0) {
                for (let e = 0; e < h.theposList.length; e++)
                    if (h.pos == h.theposList[e]) return void Laya.Scene.open(c.LoadingScene, !1);
